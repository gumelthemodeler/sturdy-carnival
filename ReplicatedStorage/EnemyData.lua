...
EnemyData.RaidBosses = {
	...
	["Raid_Part8"] = { IsBoss = true, Name = "Colossal Titan", Req = 1, Health = 12000, GateType = "Steam", GateHP = 5, Strength = 600, Defense = 100, Speed = 10, Resolve = 150, TitanStats = {Power="S", Speed="E", Hardening="C", Endurance="S", Precision="E", Potential="S"}, Skills = {"Colossal Steam", "Stomp"}, Drops = { Dews = 8000, XP = 25000, ItemChance = { ["Standard Titan Serum"] = 100, ["Spinal Fluid Syringe"] = 10, ["Ymir's Clay Fragment"] = 2, ["Glowing Titan Crystal"] = 30, ["Titan Hardening Extract"] = 20 } } }
}
