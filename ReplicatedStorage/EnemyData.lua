...
EnemyData.PathsMemories = {
	...
	{ Name = "Memory of the War Hammer", Health = 2000, GateType="Hardening", GateHP=1000, Strength = 350, Defense = 120, Speed = 90, Resolve = 250, TitanStats = {Power="None", Speed="None", Hardening="None", Endurance="None", Precision="None", Potential="None"}, Skills = {"Brutal Swipe", "War Hammer Spike"}, Drops = {XP=6000, Dews=3000, ItemChance = { ["Iron Bamboo Heart"] = 25, ["Titan Hardening Extract"] = 5 } } },
	{ Name = "Memory of the Colossal", Health = 2500, GateType="Steam", GateHP=6, Strength = 450, Defense = 80, Speed = 10, Resolve = 300, TitanStats = {Power="None", Speed="None", Hardening="None", Endurance="None", Precision="None", Potential="None"}, Skills = {"Colossal Steam", "Stomp"}, Drops = {XP=8000, Dews=5000, ItemChance = { ["Glowing Titan Crystal"] = 15, ["Titan Hardening Extract"] = 10 } } }
}
...
EnemyData.Parts = {
	[1] = {
		...
		Templates = {
			...
			["3-Meter Pure Titan"] = { Name = "3-Meter Pure Titan", Health = 40, Strength = 5, Defense = 2, Speed = 3, Resolve = 2, TitanStats = emptyTitans, Skills = {"Brutal Swipe", "Titan Grab"}, Drops = { Dews = 15, XP = 10, ItemChance = {["Cadet Training Blade"]=1} } },
			...
			-- [FIXED]: Swapped a skill to Titan Guillotine for the Perfect Clash minigame
			["Part1Boss"] = { IsBoss = true, Name = "Vanguard Abnormal (Boss)", Health = 400, Strength = 35, Defense = 15, Speed = 20, Resolve = 30, TitanStats = emptyTitans, Skills = {"Frenzied Thrash", "Stomp", "Titan Guillotine"}, Drops = { Dews = 300, XP = 400, ItemChance={["Cadet Training Blade"]=25, ["Scout Training Manual"]=5} } },
	...
	[2] = {
		...
		Templates = {
			...
			-- [FIXED]: Swapped a skill to Instructor's Wrath for the Perfect Clash minigame
			["Part2Boss"] = { IsBoss = true, IsHuman = true, Name = "Instructor Shadis", Health = 500, Strength = 35, Defense = 15, Speed = 30, Resolve = 50, TitanStats = emptyTitans, Skills = {"Heavy Slash", "Evasive Maneuver", "Instructor's Wrath"}, Drops = { Dews = 400, XP = 500, ItemChance = { ["Scout Training Manual"] = 10 } } },
	...
	[4] = {
		...
		Templates = {
			...
			-- [FIXED]: Swapped a skill to Sniper's Mark for the Perfect Clash minigame
			["Part4Boss"] = { IsHuman = true, IsBoss = true, Name = "Kenny's Lieutenant", Health = 600, Strength = 60, Defense = 35, Speed = 50, Resolve = 45, TitanStats = emptyTitans, Skills = {"Sniper's Mark", "Anti-Titan Round", "Smoke Screen"}, Drops = { Dews = 1500, XP = 2500, ItemChance = { ["Anti-Personnel Pistols"] = 25 } }, Phases = { { Health = 300, GateType = "None", GateHP = 0, Strength = 80, Defense = 20, Speed = 80, Skills = {"Heavy Slash", "Evasive Maneuver"}, Flavor = "<font color='#FFAA00'><b>The Lieutenant runs out of ammo and draws her blades!</b></font>" } } },
